...
![界面预览](https://cnb.mizhoubaobei.top/302-LLM-游乐场en.png)

## Interface Preview 
   Generate results based on user input, supporting Latex expression rendering.
   ![Expert Mode Features](https://cnb.mizhoubaobei.top/LLM英1.png)    

   Images can be uploaded as context for dialogue.
   ![Expert Mode Features](https://cnb.mizhoubaobei.top/LLM英2.png)    

   Support chart rendering.
   ![Expert Mode Features](https://cnb.mizhoubaobei.top/LLM英3.png)    
   ...
   ![Expert Mode Features](https://cnb.mizhoubaobei.top/LLM英4.jpg)
